        ...
        if (action === 'result-from-worker') {
            ...
            if (fncHandle) {
                try {
                    ...
                    (_b = __classPrivateFieldGet(this, _ParentMessenger_worker, "f")) === null || _b === void 0 ? void 0 : _b.postMessage({ action: 'result-from-parent', uuid, result, name, type: 'success' });
                }
                catch (error) {
                    (_c = __classPrivateFieldGet(this, _ParentMessenger_worker, "f")) === null || _c === void 0 ? void 0 : _c.postMessage({ action: 'result-from-parent', uuid, result: error, name, type: 'error' });
                }
            }
            else {
                (_d = __classPrivateFieldGet(this, _ParentMessenger_worker, "f")) === null || _d === void 0 ? void 0 : _d.postMessage({ action: 'result-from-parent', uuid, result: 'No handler', name, type: 'error' });
            }
        }
    }));
};
    ...
    (_a = __classPrivateFieldGet(this, _WorkerMessenger_parent, "f")) === null || _a === void 0 ? void 0 : _a.on('message', ({ action, uuid, result, type, name, data }) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (action === 'parent-call-worker') {
            ...
            if (fncHandle) {
                ...
                (_d = __classPrivateFieldGet(this, _WorkerMessenger_parent, "f")) === null || _d === void 0 ? void 0 : _d.postMessage({ action: 'result-from-worker', uuid, result: "No handler", name, type: 'error' });
            }
        }
